...
TASK.md                 # формальная постановка задачи (цели, метрики, данные, бюджет)
...
## ЛИМИТЫ
- Ресурсы системы не ограничены, но по умолчанию ≤ **10 минут** машинного времени на эксперимент (или бюджет из TASK.md).
- ≤ **5 параметров** на раунд (если не указано иначе).  
- Любой датасет/модель/код — с фиксированным seed и версией.
